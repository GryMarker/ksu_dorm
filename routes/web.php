...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('can:viewAny,App\\Models\\Room')->group(function () {
        ...
        Route::post('admin/rooms/{room}/assign', [RoomController::class, 'assign'])->name('admin.rooms.assign');
        ...
        Route::get('/qrattendance', [AdminQrAttendanceController::class, 'show'])->name('admin.attendance.qr');
        Route::get('/qrattendance/current', [AdminQrAttendanceController::class, 'current'])->name('admin.attendance.qr.current');
